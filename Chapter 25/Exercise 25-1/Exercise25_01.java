 ...
 * Date: 10/13/21
 * 
 * This program implements two new methods, breadthFirstTraversal and height(), to BST.
 */
...
public class Exercise25_01 {
  ...
  public class BinaryTree<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    public void breadthFirstTraversal() {
      ...
      // Break out of method if this root has no value
      if (this.root == null) {
    	  return;
      }

      // Add root to nodeList
