...
public class Exercise25_03 {
  public static void main(String[] args) {
    ...
    stringTree.insert("Jones");
    stringTree.insert("Peter");
    stringTree.insert("John");
    stringTree.insert("Daniel");
  ...
  public static class BST<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    public void nonRecursiveInorder() {
    	...
    	// Add elements from tree to list
    	while (!this.isEmpty()) {
    		list.add(this.root.element);
    		this.remove(root.element);
    	}
    	// Sort list
    	list.sort(null);
    	// Print list
    	System.out.println("Tree inorder is: " + list);
    }
  }
}
